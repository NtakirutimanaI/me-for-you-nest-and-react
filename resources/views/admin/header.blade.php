        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Me For</strong><strong>You</strong></div>
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <!-- Log out               -->
            <!-- Logout Link Styled as Original But Works as Form -->
<div class="list-inline-item logout">
    <a id="logout" href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
